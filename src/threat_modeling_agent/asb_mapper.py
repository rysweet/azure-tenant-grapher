...
class AzureSecurityBenchmarkMapper:
            ...
            "S": [  # Spoofing
                {
                    ...
                    "implementation": ["Enable Azure AD authentication", "Configure MFA", "Use managed identities"],
                ...
                },
                {
                    ...
                    "implementation": ["Use system-assigned managed identities", "Implement certificate-based authentication", "Avoid storing credentials in code"],
                    "category": "Identity Management"
                },
                {
                    "control_id": "IM-3",
                    ...
                    "implementation": ["Configure Azure AD SSO", "Use SAML/OIDC protocols", "Implement conditional access"],
                    "category": "Identity Management"
                }
            ],
            "T": [  # Tampering
                {
                    ...
                    "implementation": ["Enable Azure Monitor", "Configure DLP policies", "Implement access logging"],
                ...
                },
                {
                    ...
                    "implementation": ["Enable Azure Storage encryption", "Use Azure Disk Encryption", "Configure database encryption"],
                    "category": "Data Protection"
                },
                {
                    "control_id": "DP-5",
                    ...
                    "implementation": ["Enforce HTTPS", "Configure TLS 1.2+", "Use VPN for network traffic"],
                    "category": "Data Protection"
                }
            ],
            "R": [  # Repudiation
                {
                    ...
                    "implementation": ["Enable Azure Security Center", "Configure Azure Sentinel", "Set up security alerts"],
                ...
                },
                {
                    ...
                    "implementation": ["Configure SIEM", "Implement automated response", "Establish SOC procedures"],
                    "category": "Logging and Threat Detection"
                },
                {
                    "control_id": "LT-4",
                    ...
                    "implementation": ["Enable diagnostic logging", "Configure Log Analytics", "Implement log retention policies"],
                    "category": "Logging and Threat Detection"
                }
            ],
            "I": [  # Information Disclosure
                {
                    ...
                    "implementation": ["Implement data classification", "Use Azure Information Protection", "Apply sensitivity labels"],
                    "category": "Data Protection"
                },
                {
                    "control_id": "DP-2",
                    ...
                    "implementation": ["Implement RBAC", "Enable data encryption", "Use private endpoints"],
                    "category": "Data Protection"
                },
                {
                    "control_id": "NS-2", 
                    ...
                    "implementation": ["Configure private endpoints", "Implement VNet peering", "Use network segmentation"],
            ...
            "D": [  # Denial of Service
                {
                    ...
                    "implementation": ["Configure private endpoints", "Use service endpoints", "Implement network ACLs"],
                    "category": "Network Security"
                },
                {
                    "control_id": "NS-4",
                    ...
                    "implementation": ["Enable Azure DDoS Protection", "Configure WAF", "Implement rate limiting"],
                    "category": "Network Security"
                },
                {
                    "control_id": "BC-1",
                    ...
                    "implementation": ["Configure Azure Backup", "Implement geo-redundancy", "Test DR procedures"],
            ...
            "E": [  # Elevation of Privilege
                {
                    ...
                    "implementation": ["Use Azure PIM", "Implement JIT access", "Limit privileged accounts"],
                ...
                },
                {
                    ...
                    "implementation": ["Use PAWs", "Implement strict access controls", "Monitor admin activities"],
                    "category": "Privileged Access"
                },
                {
                    "control_id": "IM-7",
                    ...
                    "implementation": ["Use Azure Key Vault", "Implement credential scanning", "Avoid hardcoded secrets"],
                    "category": "Identity Management"
                }
            ]
        }
            ...
            "Microsoft.Compute/virtualMachines": [
                {
                    ...
                    "implementation": ["Deploy EDR agent", "Configure monitoring", "Enable real-time protection"],
                ...
                },
                {
                    ...
                    "implementation": ["Deploy anti-malware", "Configure central management", "Enable real-time scanning"],
                    "category": "Endpoint Security"
                }
            ],
            "Microsoft.Storage/storageAccounts": [
                {
                    ...
                    "implementation": ["Enable Azure Defender for Storage", "Configure threat alerts", "Monitor access patterns"],
                ...
                },
                {
                    ...
                    "implementation": ["Configure private endpoints", "Implement firewall rules", "Use time-limited SAS"],
                    "category": "Storage Security"
                }
            ],
            "Microsoft.Sql/servers": [
                {
                    ...
                    "implementation": ["Enable ATP for SQL", "Configure threat alerts", "Monitor query patterns"],
                ...
                },
                {
                    ...
                    "implementation": ["Use Azure AD auth", "Configure private endpoints", "Implement firewall rules"],
                    "category": "Database Security"
                }
            ],
            "Microsoft.Web/sites": [
                {
                    ...
                    "implementation": ["Enforce HTTPS only", "Use managed identities", "Enable App Insights"],
                ...
                },
                {
                    ...
                    "implementation": ["Deploy Application Gateway", "Configure WAF rules", "Enable bot protection"],
                    "category": "Application Security"
                }
            ]
        }
    ...
    def map_controls(
        ...
        for threat in threat_list:
            try:
                ...
                enhanced_controls = self._enhance_controls_for_threat(threat, asb_controls, logger)
                
                # Add priority and implementation guidance
                for control in enhanced_controls:
                    control["priority"] = self._calculate_control_priority(threat, control)
                    control["implementation_effort"] = self._estimate_implementation_effort(control)
                    control["cost_impact"] = self._estimate_cost_impact(control)
                
                threat_with_asb["asb_controls"] = enhanced_controls
                threat_with_asb["control_summary"] = self._generate_control_summary(enhanced_controls)
    ...
    def _enhance_controls_for_threat(
        self, threat: Dict[str, Any], controls: List[Dict[str, Any]], logger: logging.Logger
    ) -> List[Dict[str, Any]]:
        """
        ...
        for control in controls:
            ...
            if resource_type:
                enhanced_control["resource_specific_guidance"] = self._get_resource_specific_guidance(
    ...
    def _get_resource_specific_guidance(self, resource_type: str, control: Dict[str, Any]) -> List[str]:
        """
        Get resource-specific implementation guidance for a control.
        """
        guidance_map = {
            "Microsoft.Compute/virtualMachines": {
                "IM-1": ["Configure VM to use Azure AD joined or hybrid joined", "Enable MFA for VM access"],
                "DP-4": ["Enable Azure Disk Encryption", "Use customer-managed keys where appropriate"],
                "LT-4": ["Enable VM diagnostic logging", "Configure Log Analytics agent"]
            },
            "Microsoft.Storage/storageAccounts": {
                "DP-4": ["Enable storage service encryption", "Use customer-managed keys for enhanced security"],
                "NS-2": ["Configure private endpoints for storage", "Disable public blob access"],
                "IM-1": ["Use managed identities for storage access", "Disable shared key access"]
            },
            "Microsoft.Sql/servers": {
                "IM-1": ["Enable Azure AD authentication for SQL", "Disable SQL authentication where possible"],
                "DP-4": ["Enable Transparent Data Encryption", "Use customer-managed keys"],
                "NS-2": ["Configure private endpoints for SQL", "Implement firewall rules"]
            }
        }
    ...
    def _calculate_control_priority(self, threat: Dict[str, Any], control: Dict[str, Any]) -> str:
        """
    ...
    def _generate_control_summary(self, controls: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        categories = list(set(control.get("category", "Unknown") for control in controls))
        priorities = {}
        ...
        return {
            ...
            "high_priority_controls": len([c for c in controls if c.get("priority") == "High"]),
            "immediate_actions": len([c for c in controls if c.get("implementation_urgency") == "Immediate"])
        }
