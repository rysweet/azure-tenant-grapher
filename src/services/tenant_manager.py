...
class TenantManager:
    ...
    def __new__(
        cls, session_manager: Optional[Neo4jSessionManager] = None
    ) -> "TenantManager":
            ...
            with self.session_manager.session() as session:
                ...
                for record in result:
                    tenant_data = {
                        ...
                        "subscription_ids": json.loads(record["subscription_ids"])
...
def get_tenant_manager(
    session_manager: Optional[Neo4jSessionManager] = None,
) -> TenantManager:
    """
