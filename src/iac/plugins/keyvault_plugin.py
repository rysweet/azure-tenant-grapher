            ...
            for item in secrets:
                ...
                code_lines.extend(
                    [
                        ...
                        f'  name         = "{item.name}"',
                        "  # Reference your Key Vault resource using one of these approaches:",
                        "  # Option 1: Use data source to reference existing vault:",
                        "  #   key_vault_id = data.azurerm_key_vault.existing.id",
                        "  # Option 2: Reference vault resource created in this config:",
                        "  #   key_vault_id = azurerm_key_vault.main.id",
                        "  # Option 3: Use variable (recommended for reusable modules):",
            ...
            for item in keys:
                ...
                code_lines.extend(
                    [
                        ...
                        f'  name         = "{item.name}"',
                        "  # Reference your Key Vault - see var.key_vault_id usage",
                        "  key_vault_id = var.key_vault_id",
                        "",
