    ...
    try:
        ...
        for i in range(size):
            ...
            if start_y <= i <= start_y + letter_height:
                draw.rectangle([(start_x, i), (start_x + letter_width * 3, i + 1)], fill=color)
        ...
        draw.line([(a_points[0]), (a_points[1])], fill=(255, 255, 255, 255), width=size//40)
        draw.line([(a_points[0]), (a_points[4])], fill=(255, 255, 255, 255), width=size//40)
        draw.line([(a_points[2]), (a_points[3])], fill=(255, 255, 255, 255), width=size//40)
        
        # Draw T
        t_x = start_x + letter_width
        draw.line([(t_x, start_y), (t_x + letter_width, start_y)], fill=(255, 255, 255, 255), width=size//40)
        draw.line([(t_x + letter_width // 2, start_y), (t_x + letter_width // 2, start_y + letter_height)], fill=(255, 255, 255, 255), width=size//40)
...
def main():
    ...
    for filename, size in sizes.items():
        ...
        if filename.endswith('.ico'):
            ...
            print(f"Created {filepath.replace('.ico', '.png')} (convert to .ico for Windows)")
        else:
