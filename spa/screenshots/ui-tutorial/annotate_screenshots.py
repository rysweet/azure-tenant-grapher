...
class ScreenshotAnnotator:
    ...
    def _draw_callout(self, draw: ImageDraw, ann: Annotation):
        ...
        text_y = y + padding
        for line in lines:
            draw.text((x + padding, text_y), line, fill=AnnotationStyle.TEXT_COLOR, font=self.callout_font)
            text_y += line_height
...
def create_tutorial_screenshots():
    ...
    source_dir = Path("/home/azureuser/src/atg/worktrees/feat-issue-427-scale-operations/spa/screenshots/scale-operations")
    output_dir = Path("/home/azureuser/src/atg/worktrees/feat-issue-427-scale-operations/spa/screenshots/ui-tutorial")
    ...
    annotator.annotate(
        ...
        [
            ...
            Annotation("callout", (1450, 200, 400),
    ...
    annotator.annotate(
        ...
        [
            ...
            Annotation("callout", (1450, 400, 400),
    ...
    annotator.annotate(
        ...
        [
            ...
            Annotation("callout", (1450, 600, 400),
    ...
    annotator.annotate(
        ...
        [
            ...
            Annotation("callout", (700, 900, 500),
    ...
    annotator.annotate(
        ...
        [
            ...
            Annotation("callout", (1400, 900, 450),
    ...
    annotator.annotate(
        ...
        [
            ...
            Annotation("callout", (1450, 750, 400),
