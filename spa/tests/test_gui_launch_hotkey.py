...
class TestGUILaunchHotkey:
    ...
    def test_g_hotkey_handles_gui_already_running_error(self):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            mock_run.return_value = Mock(
                returncode=1, 
                stderr="SPA already running (pidfile exists)", 
                stdout=""
            )
    ...
    def test_g_hotkey_success_case(self):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            assert result == "GUI launched successfully! The Electron app should open in a new window."
