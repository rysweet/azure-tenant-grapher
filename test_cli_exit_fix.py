...
def test_cli_dashboard_exit():
    ...
    try:
        ...
        cmd = [
            ...
            "--no-container",
            "--test-keypress-file", keyfile_path,
            "--resource-limit", "1",
            "--max-llm-threads", "1",
        ]
        ...
        try:
            ...
            if proc.returncode == 0:
                ...
                print(f"Info: Exit code {proc.returncode} (expected due to test environment)")
                print("🎉 Dashboard exit fix is working! (Process terminated on 'x' press)")
                return True
