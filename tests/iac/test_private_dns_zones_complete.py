...
def test_private_dns_zone_mapping_exists():
    ...
    assert emitter.AZURE_TO_TERRAFORM_MAPPING["Microsoft.Network/privateDnsZones"] == "azurerm_private_dns_zone"
...
def test_multiple_private_dns_zones_emission(multiple_private_dns_zones: list[Dict[str, Any]]):
...
def test_private_dns_zone_with_vnet_link(private_dns_zone_resource: Dict[str, Any]):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        assert "${azurerm_private_dns_zone.privatelink_blob_core_windows_net.name}" in link_config["private_dns_zone_name"]
        assert "${azurerm_virtual_network.main_vnet.id}" in link_config["virtual_network_id"]
...
def test_private_dns_zone_resource_group_prefix(private_dns_zone_resource: Dict[str, Any]):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        zone_config = terraform_config["resource"]["azurerm_private_dns_zone"]["privatelink_blob_core_windows_net"]
