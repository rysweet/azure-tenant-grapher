...
class TestSPACommands:
    ...
    def test_spa_start_success(
        self, mock_makedirs, mock_exists, mock_popen, mock_which
    ):
    ...
    @patch("src.cli_commands.os.path.exists")
    @patch("src.cli_commands.os.makedirs")
    def test_spa_start_install_dependencies(
        self, mock_makedirs, mock_exists, mock_popen, mock_run, mock_which
    ):
