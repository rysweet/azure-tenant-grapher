...
async def test_resource_processor_process_resources_hangs_on_loop_exit():
    ...
    resources = [
        {"id": "r1", "name": "A", "type": "Test", "location": "westus", "resource_group": "rg", "subscription_id": "sub"},
        {"id": "r2", "name": "B", "type": "Test", "location": "eastus", "resource_group": "rg", "subscription_id": "sub"},
    ]
