...
def test_ctf_annotation_service():
    ...
    resources = [
        {"id": "vm-001", "name": "vm1", "resource_type": "Microsoft.Compute/virtualMachines"},
        {"id": "vnet-001", "name": "vnet1", "resource_type": "Microsoft.Network/virtualNetworks"}
    ]
