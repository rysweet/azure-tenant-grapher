...
class TestLSPConfigurator:
    ...
    def test_enable_lsp_updates_existing_disabled_setting(
        self, mock_project_root, mock_env_file
    ):
    ...
    def test_is_lsp_enabled_returns_false_when_disabled(
        self, mock_project_root, mock_env_file
    ):
    ...
    def test_backup_env_file_before_modification(
        self, mock_project_root, mock_env_file
    ):
    ...
    def test_handle_permission_error_on_env_file(
        self, mock_project_root, mock_env_file
    ):
