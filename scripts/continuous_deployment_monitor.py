...
def main():
    ...
    while True:
        ...
        should_update = (
            resource_count != last_resource_count or
        ...
        if resource_count > 0 and not terraform_running:
            ...
            send_update(f"🎉 Iteration {CURRENT_ITERATION} deployment finished with {resource_count} resources!")
            break
